...
<html>
    <head>
        ...
        <title><g:message code="editar.infogeneral.label" /></title>
    </head>
    <body>
    <ol class="breadcrumb">
        ...
        <li class="active"><g:message code="editar.infogeneral.label"/></li>
    </ol>
        <div class="row">
            <div class="col-lg-6 col-lg-offset-3">
            <h4><i class="fa fa-university"></i> <g:message code="editar.infogeneral.label" /></h4>
                <hr>
