<div class="panel panel-info">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <label for="fechaVencimiento"><g:message code="actuacion.fechaVencimiento"/></label>
        ...
        <div class="form-group">
            <label for="notas"><g:message code="actuacion.notas"/></label>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    <label for="fechaFin"><g:message code="actuacion.fechaFin"/></label>
